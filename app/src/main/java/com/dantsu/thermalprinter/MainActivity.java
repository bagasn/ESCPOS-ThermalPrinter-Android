...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText etPaperWidth, etNumChar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPaperWidth = (EditText) findViewById(R.id.et_paper_width);
        etNumChar = (EditText) findViewById(R.id.et_num_char);
    }
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false)) {
                        if (usbManager != null && usbDevice != null) {
                            new AsyncUsbEscPosPrint(
                                    ...
                                    .execute(getAsyncTokai(new UsbConnection(usbManager, usbDevice)));
                        }
                    }
                }
            }
    ...
    String printImage(AsyncEscPosPrinter printer) {
    ...
    public AsyncEscPosPrinter getAsyncTokai(DeviceConnection printerConnection) {
        SimpleDateFormat format = new SimpleDateFormat("'on' yyyy-MM-dd 'at' HH:mm:ss");

        float paperWidth = Float.parseFloat(etPaperWidth.getText().toString());
        int numChar = Integer.parseInt(etNumChar.getText().toString());

        AsyncEscPosPrinter printer = new AsyncEscPosPrinter(printerConnection, 203, paperWidth, numChar);
        String image = PrinterTextParserImg.bitmapToHexadecimalString(printer,
                this.getApplicationContext().getResources()
                        .getDrawableForDensity(R.drawable.logo, DisplayMetrics.DENSITY_MEDIUM)
        );
        return printer.addTextToPrint(
//                TextPrint.printTokai(printer, image)
                printImage(printer) +
                        printQR() +
                        printBarcode() +
                        printInvoice()
